  ...
  return (
    <div className="py-[15.26px] px-[14.3px] rounded-[18.91px] flex justify-center items-center bg-[#26201E] w-full max-w-[622px] mx-auto">
      <div
        ...
        style={{
          backgroundImage: `url(${project.thumbnail_image_url || '/images/project_card_bg.png'})`,
        ...
        <div className="flex flex-col rounded-[59px] md:flex-row gap-[22.29px] py-[5.81px] pl-[5.79px] pr-[10.71px] justify-center items-center bg-black/83">
          ...
          <div className="flex flex-col sm:flex-row gap-[10.83px] justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center sm:items-start gap-[11px]">
              ...
              <p className="font-normal text-base leading-[24px] tracking-[0px] text-white/[0.77] text-center sm:text-start max-w-xs line-clamp-2">
          ...
          <Link href={`/case-study/project-details/${project._id}`}>
            <div className="flex justify-center items-center py-[7px] lg:py-[14px] px-[12px] lg:px-[24px] rounded-[30px] bg-[#1D9ED9] w-full max-w-[164px] cursor-pointer border border-white/[0.60] hover:bg-[#1678a1] transition-colors">
